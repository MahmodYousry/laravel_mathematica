                ...
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                    ...
                    <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-alt">
                            ...
                            <li class="breadcrumb-item">{{ trans('teachers.add_teacher') }}</li>
                    ...
                    <form action="{{ route('teachers.store') }}" method="POST">
                        ...
                        <div class="form-row mb-3">
                            <div class="col">
                                ...
                                <input id="teacher_name" type="text" name="Name_ar" class="form-control" >
                                @error('teacher_name')
                                    <div class="alert alert-danger my-2">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col">
                                ...
                                <input id="teacher_name_en" type="text" name="Name_en" class="form-control" >
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="js-flatpickr form-control bg-white" id="flatpickr" name="Joining_Date" placeholder="Y-m-d">
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="teacher_address">{{trans('teachers.address')}}</label>
                            <textarea class="form-control" name="Address" id="teacher_address" rows="4"></textarea>
                        ...
                        <div class="form-group">
                            <button class="btn btn-primary btn-md" type="submit"><i class="fa fa-check fa-fw mr-1"></i>{{ trans('grades.save') }}</button>
                        </div>
                    </form>
                </div>
            </div>
