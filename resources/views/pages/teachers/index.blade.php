        ...
        <div class="content">
            <div class="block block-rounded">
                <div class="block-content">
                    <a href="{{ route('teachers.create') }}" class="btn btn-success mr-1 mb-3">
                        <i class="fa fa-fw fa-plus mr-1"></i> {{ trans('teachers.add_teacher') }}
                    </a>
                        ...
                        <tbody>
                            ...
                            @foreach ($teachers as $teacher)
                                <tr>
                                    ...
                                    <div class="modal fade" id="modal-delete-teacher{{$teacher->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-block-large" aria-hidden="true">
